function outputs = plot_training_sample_full()
%PLOT_TRAINING_SAMPLE_FULL Plot final Main-DGP-aligned training-size sensitivity.
...
stem = fullfile(fig_dir, 'training_mainDGP_aligned_deltaR');
make_delta_figure(summary, 'Ntr', 'training sample size N_{tr}', stem, true);
